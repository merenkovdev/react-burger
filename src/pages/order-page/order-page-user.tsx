...
import { wsCloseConnetion, wsConnectionInit } from '../../services/actions/ws-orders-user-actions';

const OrderPageUser: FC = () => {
	const { id } = useParams<{ id: string | undefined }>();
	const {	orders, wsConnected } = useSelector(store => store.orders.ordersUser);
